...
if __name__ == '__main__':
    ...
    for i, lam in enumerate(lambda_list):
        ...
        if lam == 0.0 and False:
            ...
            plt.plot(grids, 2 * n2_r0_dmrg[0],
                     label=r'density from $ v_{ext} + (1/2)v_H[n^{DMRG}]$')
