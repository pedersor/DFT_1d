...
print(top_dir)
code_path = os.path.join(top_dir, 'DFT_1d')
print(code_path)
...
project = '1D Solver'
copyright = '2020, Ryan Pederson, and others too'
author = 'Ryan Pederson, and others too'
...
#autodoc_mock_imports = ["pyscf", "pyfort"] #Use if you need to exclude an import
